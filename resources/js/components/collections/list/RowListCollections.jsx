    ...
    return (
        ...
        >
            ...
            <div className="w-full min-w-[130px] h-12 flex flex-row justify-start items-center cursor-pointer text-[15px] lg:text-base truncate">
                {collectionFiltered && (
                    <span className="truncate font-semibold">{collectionFiltered.name}</span>
                )}
            </div>
            ...
            {screenSize > 559 &&
                <div className="w-full min-w-[130px] flex justify-start items-center">
                    <span
                        className={`flex flex-row justify-center items-center rounded-l-[16px] rounded-r-md w-32 h-8 pl-2.5 text-[15px] lg:text-base font-semibold ${collectionFiltered?.status == 1 ||
