...
const ListCollections = () => {
    ...
    useEffect(() => {
        ...
        setHasLeaveThisPage('collectionsList')
    }, []);
                ...
                className={`w-full py-4 grid ${gridCols} gap-2 bg-gray-50 rounded-t-md`}>
                    ...
                    {screenSize > 1149 &&
                        <div className='w-full h-12 flex flex-row justify-start items-center pl-2 xl:pl-0'>
                            <span className='cursor-pointer shrink-0 font-medium' onClick={() => sortList('created_at')}>Créée le</span>
