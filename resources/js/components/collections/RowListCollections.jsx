...
const RowListCollections = ({ collection }) => {
    ...
    return (
        <div className={classes.inputText + " searchRowInputText"}>
            ...
            <i className={classes.trash + " far fa-trash-alt trash-alt-dropZone tooltip_"} style={{ display: "block", marginLeft: "auto" }} onClick={() => { handleDeletCollection(collection.id) }}>
