...
const HeaderIndex = () => {
    ...
    const { setShowModalConfirm, setMessageModal, setSender, isDirty, setTextButtonConfirm, setImageModal, setConditions, setIdCollection, setTmp_parameter } = useContext(AppContext);
