...
const DropZoneProduct = () => {
    ...
    useEffect(() => {
        ...
        if (image.length > 0) {
            ...
            dropRegion.className = "flex-col justify-start items-center bg-white rounded-md w-full py-[40px] border-2 border-slate-200  cursor-default";
    ...
    return (
        <div id="main-image-product"
            ...
            <div id="drop-region"
                className="w-full h-full flex-col justify-start items-center bg-white rounded-md py-[40px] border-dashed border-4 border-slate-300 hover:bg-slate-50 cursor-pointer brd-blue-1">
                <div className="drop-message w-full flex flex-row flex-nowrap justify-around items-center">
                    <span>Déposez vos images ou cliquez pour télécharger
                    </span>
                    {/* dropCard add images */}
                    <div id="drop-card"
                        className='flex-col justify-center items-center w-[80px] h-[80px] p-[20px] border-dashed border-4 border-slate-300 hover:bg-slate-50 cursor-pointer rounded'
                ...
                >
                    {image.length > 0 && image.map((item_tab, ndx) => (
                        <Droppable droppableId={`${ndx}`}
                            ...
                            {(provided, snapshot) => (
                                <div
                                    className='flex flrex-row flex-nowrap justify-center my-[5px] w-full h-[120px]'
                                ...
                                >
                                    {item_tab.map((item, index) => (
                                        ...
                                        >
                                            {(provided, snapshot) => (
                                                <div
                                                    className="image-view flex flex-row justify-start items-center mb[20px] mx-[10px] h-auto w-[(calc(100% / 4) - 10px] relative  border border-slate-300 rounded group"
                                                    ref={provided.innerRef}
