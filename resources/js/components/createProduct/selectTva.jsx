...
export default function SelectTva({ list, itemSelected, setItemSelected, toggleSelect, setToggleSelect, selectValueColor, setSelectValueColor, ulUnikId, buttonUnikId }) {
    ...
    useEffect(() => {
        ...
        if (ndx > -1) {
            ...
            setItemSelected(prevState => ({...prevState, tva: list[ndx]}));
        }
    ...
    const handleChangeSelect = (item, index) => {
        ...
        setItemSelected(prevState => ({...prevState, tva: item}));
        showSelectMenu();
    };
    ...
    const cancelSelected = () => {
        setItemSelected(prevState => ({...prevState, tva: ''}));
        setSelectValueColor('');
    }
