...
export default function SelectSupplier({ list, itemSelected, setItemSelected, toggleSelect, setToggleSelect, selectValueColor, setSelectValueColor, ulUnikId, buttonUnikId }) {
    ...
    useEffect(() => {
        ...
        if (ndx > -1) {
            ...
            setItemSelected(prevState => ({...prevState, supplier: list[ndx]}));
        }
    ...
    const handleChangeSelect = (item, index) => {
        ...
        setItemSelected(prevState => ({...prevState, supplier: item}));
        showSelectMenu();
    };
    ...
    const cancelSelected = () => {
        setItemSelected(prevState => ({...prevState, supplier: ''}));
        setSelectValueColor('');
    }

    // sélectionne la couleur blanche pour la pastille s'il n'y a pas de itemSelected sélectionné
    itemSelected?.length > 0 && itemSelected == '' && setSelectValueColor(84);
